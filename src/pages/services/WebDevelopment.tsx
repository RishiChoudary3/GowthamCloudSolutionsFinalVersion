  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <Navigation onNavigate={() => window.location.href = '/'} currentPage="web-development" isDark />
        <div className="container mx-auto px-6 py-16">
          <button onClick={() => window.location.href = '/'} className="inline-flex items-center text-white hover:text-blue-200 mb-8">
      ...
      >
        <div className="max-w-lg mx-auto">
          <p className="text-gray-600 mb-6">
            Fill out the form below and we'll get back to you to discuss your web development project.
          </p>
          <ContactForm />
        </div>
      </Dialog>
