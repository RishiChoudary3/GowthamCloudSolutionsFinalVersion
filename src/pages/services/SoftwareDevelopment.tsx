    ...
    <div className="min-h-screen bg-white">
      <header className="bg-gradient-to-r from-blue-900 to-blue-700 text-white py-16">
        <div className="container mx-auto px-6">
          ...
          <p className="text-xl">Custom software solutions tailored to your business needs</p>
        </div>
      </header>
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-3xl font-bold mb-6">Custom Software Solutions</h2>
      ...
      >
        <div className="max-w-lg mx-auto">
          <p className="text-gray-600 mb-6">
            Fill out the form below and we'll get back to you to discuss your software development needs.
          </p>
          <ContactForm />
        </div>
      </Dialog>
